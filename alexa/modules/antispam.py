...
import alexa.modules.sql.antispam_sql as sql
from alexa import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, STRICT_ANTISPAM
...
from alexa.modules.helper_funcs.misc import send_to_list
...
GMUTE_LIST = CommandHandler("gmutelist", gmutelist, filters=Filters.user(OWNER_ID))
